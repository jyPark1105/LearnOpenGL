...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/shadow mapping vs.vs", "shaders/shadow mapping fs.fs");
    Shader simpleDepthShader("shaders/simple depth vs.vs", "shaders/simple depth fs.fs", "shaders/simple depth gs.gs");
    Shader debugDepthQuad("shaders/debug depth quad vs.vs", "shaders/debug depth quad fs.fs");
    Shader debugCascadeShader("shaders/debug cascade vs.vs", "shaders/debug cascade fs.fs");
