...
bool BloomRenderer::Init(unsigned int windowWidth, unsigned int windowHeight)
{
    ...
    // Shaders
    mDownsampleShader = new Shader("shaders/down sample.vs", "shaders/down sample.fs");
    mUpsampleShader = new Shader("shaders/up sample.vs", "shaders/up sample.fs");
...
int main()
{
    ...
    Shader shaderLight("shaders/light vs.vs", "shaders/light fs.fs");
    Shader shaderBlur("shaders/blur vs.vs", "shaders/blur fs.fs");
    Shader shaderBloomFinal("shaders/bloom vs.vs", "shaders/bloom fs.fs");
