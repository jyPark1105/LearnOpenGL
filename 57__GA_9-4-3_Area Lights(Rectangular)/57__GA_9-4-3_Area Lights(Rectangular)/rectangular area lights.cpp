...
// CUSTOM
#include "headers/ltc_matrix.hpp"
...
// Custom
const glm::vec3 LIGHT_COLOR = glm::vec3(0.87f, 0.72f, 0.53f); // BurlyWood VERSION
...
{
    // SLATEGRAY_COLOR 
    static glm::vec3 color = glm::vec3(0.44f, 0.50f, 0.56f);
...
int main()
{
    ...
    // SHADERS
    Shader shaderLTC("shaders/ltc vs.vs", "shaders/ltc fs.fs");
    ltcShaderPtr = &shaderLTC;
    Shader shaderLightPlane("shaders/light plane vs.vs", "shaders/light plane fs.fs");

    // TEXTURES
    unsigned int concreteTexture = loadTexture("resources/textures/concreteTexture.jpg", true);
